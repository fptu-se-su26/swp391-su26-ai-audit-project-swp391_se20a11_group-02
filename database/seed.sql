...
(1, 1, 'Summer Code Clash 2026', 'Welcome to the annual Summer Code Clash! Solve 2 problems A & B under strict ICPC rules to win special awards.', 'ICPC', NULL, CURRENT_TIMESTAMP - INTERVAL '1 hour', CURRENT_TIMESTAMP + INTERVAL '3 hours', 240, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(3, 1, 'Algorithmic Masters Cup', 'The final round of Masters Cup 2026. This contest has ended.', 'IOI', NULL, CURRENT_TIMESTAMP - INTERVAL '5 days', CURRENT_TIMESTAMP - INTERVAL '4 days 20 hours', 240, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
