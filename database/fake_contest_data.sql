...
INSERT INTO public.problems (id, title, description, input_description, output_description, constraints, example_input, example_output, hint, problem_scope, difficulty, is_active, created_by, created_by_teacher_id, total_testcase, time_limit_ms, memory_limit_kb, is_public, total_submission, total_accepted, score)
VALUES
(990, 'Two Sum in Contest', 'Given an array of integers nums and an integer target, return indices of the two numbers such that they add up to target.', 'Array of integers nums and integer target.', 'Indices of the two numbers.', '2 <= nums.length <= 10^4', '[2,7,11,15]\n9', '[0,1]', 'Use a hash map.', 'CONTEST'::public.problem_scope, 'EASY'::public.problem_difficulty, true, 999, 999, 10, 1000, 64000, true, 4, 3, 100.00),
(991, 'Contest Palindrome Number', 'Determine whether an integer is a palindrome. An integer is a palindrome when it reads the same backward as forward.', 'An integer x.', 'True or False.', '-2^31 <= x <= 2^31 - 1', '121', 'true', 'Reverse the integer.', 'CONTEST'::public.problem_scope, 'EASY'::public.problem_difficulty, true, 999, 999, 5, 1000, 64000, true, 2, 1, 100.00),
(992, 'Contest Longest Common Prefix', 'Write a function to find the longest common prefix string amongst an array of strings.', 'Array of strings.', 'Longest common prefix.', '0 <= strs.length <= 200', '["flower","flow","flight"]', '"fl"', 'Compare characters vertically.', 'CONTEST'::public.problem_scope, 'EASY'::public.problem_difficulty, true, 999, 999, 8, 1000, 64000, true, 0, 0, 100.00),
(993, 'Contest Valid Parentheses', 'Given a string s containing just the characters brackets, determine if the input string is valid.', 'A string s containing brackets.', 'True or False.', '1 <= s.length <= 10^4', '"()[]{}"', 'true', 'Use a stack.', 'CONTEST'::public.problem_scope, 'MEDIUM'::public.problem_difficulty, true, 999, 999, 12, 1000, 64000, true, 0, 0, 100.00),
(994, 'Contest Merge Two Sorted Lists', 'Merge two sorted linked lists and return it as a sorted list.', 'Two sorted linked lists.', 'Merged sorted linked list.', 'Number of nodes in both lists is in range [0, 50].', '[1,2,4]\n[1,3,4]', '[1,1,2,3,4,4]', 'Use recursion or iteration.', 'CONTEST'::public.problem_scope, 'MEDIUM'::public.problem_difficulty, true, 999, 999, 6, 1000, 64000, true, 0, 0, 100.00)
ON CONFLICT (id) DO NOTHING;
