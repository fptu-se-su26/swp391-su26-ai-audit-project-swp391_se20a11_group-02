...
public class ProblemSubmissionService {
    ...
    // @Transactional
    // public SubmitResponse submitProblem(Integer id, Long userId, SubmitRequest
    // request) {
    // if (userId == null) {
    ...
    // problemTestcaseRepository.findByProblemIdOrderByOrderIndexAsc(id);
    //
    ...
    // ProblemSubmissionDetailEntity detail =
    // ProblemSubmissionDetailEntity.builder()
    ...
    // }
    //
    // problem.setTotalSubmission(problem.getTotalSubmission() != null ?
    // problem.getTotalSubmission() + 1 : 1);
    // problem.setTotalAccepted(problem.getTotalAccepted() != null ?
    // problem.getTotalAccepted() + 1 : 1);
    ...
    public List<ProblemSubmissionResponse> getSubmissions(Integer problemId, Long userId) {
        ...
        for (ProblemSubmissionEntity s : sortedSubs) {
            ...
            String runtimeStr = s.getExecutionTime() != null ? String.format(Locale.US, "%.1f ms", s.getExecutionTime())
                    : "N/A";
