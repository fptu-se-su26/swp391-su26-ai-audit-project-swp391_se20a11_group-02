...
public class AdminDashboardController {
    ...
    @GetMapping("/admin/dashboard/recent-deposits")
    ...
    @GetMapping("/admin/dashboard/financial")
    ...
    @GetMapping("/admin/dashboard/financial/details")
    public ResponseEntity<ApiResponse<AdminFinancialDetailsResponse>> getFinancialDetails() {
        AdminFinancialDetailsResponse result = adminDashboardService.getFinancialDetails();
        return ResponseEntity.ok(ApiResponse.<AdminFinancialDetailsResponse>builder()
                .status(200)
                .code(1000)
