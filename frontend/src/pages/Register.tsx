    ...
    >
      ...
      <main className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10 flex flex-col items-center">
          ...
          <p className="font-body text-text-muted mt-2 font-medium">Join us! Please enter your details.</p>
        </div>
        ...
        <div className="bg-surface rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10 transition-all duration-300 hover:shadow-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Full Name */}
            <div>
              <label className="block font-medium text-text-main text-sm mb-1.5" htmlFor="fullname">
                Full Name
              </label>
            ...
            {/* Username */}
            <div>
              <label className="block font-medium text-text-main text-sm mb-1.5" htmlFor="username">
                Username
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            {/* Email Address */}
            <div>
              <label className="block font-medium text-text-main text-sm mb-1.5" htmlFor="email">
                Email Address
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            {/* Password */}
            <div>
              <label className="block font-medium text-text-main text-sm mb-1.5" htmlFor="password">
                Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            {/* Confirm Password */}
            <div>
              <label className="block font-medium text-text-main text-sm mb-1.5" htmlFor="confirm-password">
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <div className="flex items-start pt-1">
              <input
                className="h-4 w-4 mt-0.5 text-primary focus:ring-primary border-gray-300 rounded cursor-pointer shrink-0"
                id="terms"
                name="terms"
                required
                type="checkbox"
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-surface text-text-muted text-xs uppercase tracking-wider font-semibold">Or register with</span>
              </div>
            </div>
        ...
        <p className="mt-8 text-center text-sm text-text-muted">
          ...
          <Link className="font-bold text-primary hover:text-primary-hover transition-colors underline decoration-2 underline-offset-4 decoration-primary/30 hover:decoration-primary" to="/login">Log In</Link>
        </p>
      </main>
    </div>
  );
